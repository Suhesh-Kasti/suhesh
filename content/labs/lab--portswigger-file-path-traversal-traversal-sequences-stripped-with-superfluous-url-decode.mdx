...
tags:
  ...
  - walkthrough
excerpt: >-
  PortSwigger Web Security Academy lab — File path traversal, traversal
  sequences stripped with superfluous URL-decode. Walkthrough with solution, key
  takeaways, and blind replay exercise.
type: lab
