...
![Two switches connected by a single trunk port carrying several VLANs, with access ports on each side](/images/content/virtual-lans/trunk_port_passage.png)
