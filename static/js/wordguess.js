...
"f5101": [
  {
    ...
    "question": "What describes the third \u2018\u2019A\u2019\u2019 in the common authentication acronym AAA?"
  },
  {
  ...
  },
  {
    ...
    "question": "A BIG-IP Administrator contacts F5 Support and is asked to upload a Support Snapshot. Which command should be entered to the CLI to generate the requested\nfile?"
  },
  {
  ...
  },
  {
    ...
    "question": "What should a BIG-IP Administrator configure to minimize impact during a failure?"
  },
  {
    "correctAnswer": "Download the product version image from downloads f5.com",
    "options": [
    ...
    "question": "What is the correct procedure to comply with the recommendation?"
  },
  {
    "correctAnswer": "II failing over network connection based on heartbeat detection",
    "options": [
    ...
    "question": "What are Iwo examples of failover capabilities of BIG-IP? (Choose two )"
  },
  {
    ...
    "question": "Which FTP mode should be used by a client behind a firewall that has no special configurator?"
  },
  {
    ...
    "question": "What should the administrator investigate first to address this traffic slownes"
  },
  {
    ...
    "question": "An administrator lakes a capture of five Traffic using tcpdump. The administrator notices that different ephemeral port numbers are architecture does this indicate?"
  },
  {
    ...
    "question": "What is a primary reason to choose hardware over virtual devices?"
  },
  {
    ...
    "question": "A new VLAN segment has been added to the network. Only the existing connected interface may be used. What should the BIG-IP Administrator do to allow traffic\nto both the existing and the new VLAN?"
  },
  {
    ...
    "question": "BIG-IP ASM is requesting automatic signature updates from the F5 update service\nWho is considered the server in this communication?"
  },
  {
    ...
    "question": "A BIG-IP Administrator needs to configure a MAC masquerade address for traffic-group 1. Where on the GUI should this configuration be performed?"
  },
  {
    "correctAnswer": "when the number of TCP connections to the server must be optimized",
    "options": [
  ...
  {
    "correctAnswer": "Ensuring requests from a single source always end up being handled by the same server.",
    "options": [
    ...
    "question": "In the context of load balancing, what does the term persistence\" refer to?"
  },
  {
  ...
  },
  {
    ...
    "question": "An administrator notices the following log message generated by a BIG IP system \" diskmonitor 011d005: Disk partition shared has less than 30% tree\" Which\ncommand should the administrator use to troubleshoot the problem?"
  },
  {
    ...
    "question": "In wh.ch layer of the OSI model is the data transported in the form of a packet?"
  },
  {
    ...
    "question": "in which scenario would an SSL VPN solution have an advantage over an IPSec VPN?"
  },
  {
    ...
    "question": "Which techology can be used on a BIG-IP device to accelerate the delivery of the same content to multiple user?"
  },
  {
    ...
    "question": "A messaging system digitally signs messages to ensure non-repudiation of the sender. Which component should the receiver use to validate the message?"
  },
  {
  ...
  },
  {
    ...
    "question": "An IPv4 client tries to access to http://www myserver com\nWhich type of DNS request should the client send to its configured DNS server?"
  },
  {
    "correctAnswer": "a route for 0. 0. 0.0/0 on Branch1 to Core1, and a route for 192 168 1 0/24 from Core 1 to Branch1",
    "options": [
  ...
  },
  {
    ...
    "question": "A BIG-IP Administrator needs to make sure that requests from a single user are directed to the server that was initially selected (unless that server is marked\ndown). What should the administrator configure?"
  },
  {
    ...
    "question": "A client\u2019s operating system needs to make sure that data received from a server is mapped to the application that requested it.\nHow does it complete this mapping?"
  },
  {
    "correctAnswer": "HTTP",
    "options": [
    ...
    "question": "BIG-IP Administrator performs the capture as shown in the image! On which protocol is the application responding?"
  },
  {
    ...
    "question": "A BIG-IP Administrator needs to create a route to send traffic destined to 10.1.1 1 to another router with an address of 192 168 1 1 Which TMSH command should\nthe administrator use?"
  },
  {
    ...
    "question": "What advantage does an active-standby configuration have over an active-active configurations?"
  },
  {
  ...
  },
  {
    ...
    "question": "In an active/standby high-availability mode, what causes a standby unit to assume the active role?"
  },
  {
    ...
    "question": "An administrator needs to prepare change control documents for operations staff To reduce possible errors the administrator killed number of default configuration\nPassing Certification Exams Made Easy\nvisit - https://www.surepassexam.comRecommend!! Get the Full 101 dumps in VCE and PDF From SurePassExam\nhttps://www.surepassexam.com/101-exam-dumps.html (240 New Questions)\noptions is choose from. Which F5 feature is intended to help with this task?"
  },
  {
  ...
  },
  {
    ...
    "question": "A company would like to create a web service for multiple data centers (US EU, ASia) where each data center uses the same IP address Requests will be routed\nto the closest data center. Which address type is the appropriate solution?"
  },
  {
    "correctAnswer": "to modify application traffic between the client and server",
    "options": [
  ...
  },
  {
    ...
    "question": "An Administrator enables HTTP keep alive. How does this affect the network?"
  },
  {
  ...
  },
  {
    ...
    "question": "Given the service list of a server shown, the administrator needs to determine why users are unable to resolve the IP addresswww.example.com.\nWhat is the causing this issue?"
  },
  {
    ...
    "question": "Which of the following is a valid IP address and prefix length?"
  },
  {
  ...
  },
  {
    ...
    "question": "A company deploys F5 load balancers to manage a large number of secure applications. The company manage certificates. Which F5 provides this functionality?"
  },
  {
    ...
    "question": "A client needs to learn if a web server supports POST Which HTTP method is used?"
  },
  {
    "correctAnswer": "Virtual server using client SSL profile configured to use the certificate",
    "options": [
    ...
    "question": "What should the BIG-IP Administrator configure to perform SSL offloading when the certificate is already imported on the BIG-IP device?"
  },
  {
    ...
    "question": "Ping and Traceroute outputs are provided for a connectivity issue. What is the cause of these results?"
  },
  {
    ...
    "question": "Without decrypting, what portion of an HTTPS session is visible with a packet capture?"
  },
  {
    "correctAnswer": "LLC",
    "options": [
    ...
    "question": "Which Datalink sublayer has the primary funcl.cn of proving node lo node flow and error control?"
  },
  {
    ...
    "question": "A BIG-IP Administrator has a cluster of devices.\nWhat should the administrator do after creating a new Virtual Server on device 1?"
  },
  {
    "correctAnswer": "so that application traffic can do gracefully resumed after a failover",
    "options": [
    ...
    "question": "Why is it important that devices in a high availability pair share the same configuration?"
  },
  {
    ...
    "question": "A BIG-IP Administrator needs a solution to tunnel traffic and transmit encrypted connections over the Internet using only a standard browser and common ports\nand protocols. Which solution should the administrator select?"
  },
  {
    ...
    "question": "A user is trying to access a website using the URL https://1.1.1.1/ The website fails to load. The user can access other websites. Given the packet capture above,\nwhat is the most likely issue?"
  },
  {
    "correctAnswer": "2",
    "options": [
    ...
    "question": "An administrator is given the IP Address of 192.168.100.124 and needs 64 subnets. How many hosts per network are allowed?"
  },
  {
    ...
    "question": "In a fully proxy architecture, what is considered the client in the server-side communications"
  },
  {
    "correctAnswer": "ARP",
    "options": [
  ...
  },
  {
    ...
    "question": "What is used to establish trust relationships between BIG-IP devices?"
  },
  {
    ...
    "question": "HTTP pool attached to a Virtual Server has three members Pool member A default HTTP monitor in red Pool member 6 custom HTTP monitor in green Pool\nmember C does not monitor\nWhich pool members participate in the load balancing?"
  },
  {
  ...
  },
  {
    ...
    "question": "Which security model provides protection from unknown attacks?"
  },
  {
    ...
    "question": "ATP administrator recently added a new VLAN and needs to confirm that the BIG IP sees traffic on this VLAN. The VLAN is untagged on interface 1.1 and is\nnamed VLAN704 in the BIG IP Configuration Unity.\nWhich tool should be used to generate a packet capture that shows all traffic on this VLAN?"
  },
  {
    ...
    "question": "A client is transmitting a large amount of data to a server During this process, the server sets the window size to zero What is the likely cause of this issue?"
  },
  {
    ...
    "question": "Which support service is required to synchrony the time stamps in system logs from these devices?"
  },
  {
    ...
    "question": "Web application http://www.example.com at 10.10.1.1.110, is unresponsive. A recent change migrated DNS to a new platform"
  },
  {
    ...
    "question": "An application has a mix of both and short and long lived connections. Which algorithm would provide and event distributionof all connections across the pool?"
  },
  {
    ...
    "question": "Which method should an administrator of the BIG-IP use to sync the configuration to only certain other BIG-IPs?"
  },
  {
    "correctAnswer": "The requested resource resides temporary under a different URI",
    "options": [
  ...
  },
  {
    ...
    "question": "Which device group type allows a BIG IP system to automatically become active in the event that the current active system fails?"
  },
  {
    ...
    "question": "Which device type in the topology will forward network packets without an OSI layer 3 address assigned to a data plane interface?"
  },
  {
    "correctAnswer": "ntpq",
    "options": [
    ...
    "question": "A BIG IP Administrator configures three Network Time Protocol servers to keep the time of the devices in sync. Which tool should the administrator use to show\nthe synchronization status with the Network Time Protocol servers?"
  },
  {
    "correctAnswer": "RST",
    "options": [
    ...
    "question": "After all expected HTTP data has been sent from a server to a client, the client does not close connection. The server reaps the connection, but after that the client\nsends a \u2018\u2019Keep alive \u2018\u2019packet to the server.\nWhich type of packet will the server respond with?"
  },
  {
    ...
    "question": "At which layer of the OSJ model does the DNS resolution process occur?"
  },
  {
    ...
    "question": "If there are multiple applications authenticated against a single identity store, which technology solution will simplify access to all applications?"
  },
  {
    "correctAnswer": "(Rules",
    "options": [
    ...
    "question": "A company needs to use a custom value when making persistence decisions.Which F5 product provides this functionality?"
  },
  {
    ...
    "question": "An administrate receives an error message when attempting to create a self-IP address on a BIG-IP appliance Which address should the administrator use to\nresolve the issue?"
  },
  {
    ...
    "question": "Which TransportLayer Security (TLS) extension can be used to enable a single virtual server to serve multiple HTTPS websites in different can be used to enable\na single virtual server to server domains?"
  },
  {
    ...
    "question": "Cryptographic hash functions can be used to provide which service?\nPassing Certification Exams Made Easy\nvisit - https://www.surepassexam.comRecommend!! Get the Full 101 dumps in VCE and PDF From SurePassExam\nhttps://www.surepassexam.com/101-exam-dumps.html (240 New Questions)"
  },
  {
    "correctAnswer": "tcpdump",
    "options": [
    ...
    "question": "A BIG IP Administrator need to perform a packet capture and identify the source IP that is connecting to the Virtual Server.\nWhich utility should the administrator use on the BIG IP device?"
  },
  {
    "correctAnswer": "ASM",
    "options": [
    ...
    "question": "An administrator needs to protect a web application from cross-site scripting (CSS) exploits. Which F5 protocol provide this functionality"
  },
  {
    "correctAnswer": "ARP",
    "options": [
    ...
    "question": "What are two examples of network layer protocols? (Choose two)"
  },
  {
  ...
  },
  {
    ...
    "question": "Which security mode. functions by defining what traffic is allowed and rejecting all other traffic?"
  },
  {
    ...
    "question": "An administrator needs to rapidly deter e newly discovered security threat to a remote desktop application. Which F5 feature provides this functionality?"
  },
  {
    "correctAnswer": "Ratio",
    "options": [
    ...
    "question": "A server is capable of handling more connections than other servers in the same pool. Which load distribution method should the administrator choose?"
  },
  {
    ...
    "question": "An administrator needs to connect a new device to a switched network. The interconnect must be both redundant and combined bandwidth than a single link\nWhich low-level protocol will help facilitate this?"
  },
  {
    "correctAnswer": "The larger Key size will increase processing requirements",
    "options": [
    ...
    "question": "An administrator is updating private keys used for SSL encryption from 1024 to 2048 bits. Which possible effect should the administrator consider when performing\nthis activity?"
  },
  {
    ...
    "question": "The use of attack signature within an intrusion Detection System (IDS) is an application of which security model?"
  },
  {
    ...
    "question": "If a workstation is configured with an address of 224 0.0.1 which functionality will it allow?"
  }
]
  };
