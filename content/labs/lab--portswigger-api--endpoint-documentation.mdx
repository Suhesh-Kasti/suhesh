...
- [ ] Step 1: ![Burp Proxy history showing the web app making its own calls to the /api endpoint](/images/content/lab--portswigger-api--endpoint-documentation/api_found_being_used_documentation.png)
- [ ] Step 2:
![The exposed API documentation page served at /api, listing every available endpoint](/images/content/lab--portswigger-api--endpoint-documentation/found_exposed_API_docs%20_in_slashAPI.png)
- [ ] Step 3:
    ![The DELETE request sent from the exposed API docs that removes the user carlos](/images/content/lab--portswigger-api--endpoint-documentation/api_deleted_user_through_exposed_docs.png)
