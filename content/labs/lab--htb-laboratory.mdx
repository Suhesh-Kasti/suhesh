...
date: '2026-07-01'
tags: ["lab/htb", "walkthrough", "Enumeration", "nmap", "Linux"]
excerpt: "An HTB walkthrough in progress: nmap reveals SSH, HTTP and HTTPS, and the TLS certificate's SAN field leaks the git.laboratory.htb vhost."
type: lab
...
<Cloze title="Laboratory recon recall" color="#0055ff" text="Nmap shows 22, 80 and {{443}} open. The HTTPS certificate's Subject Alternative Name is DNS:{{git.laboratory.htb}}, which leaks the extra vhost to add to /etc/hosts." />
