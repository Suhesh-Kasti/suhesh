...
![A full proxy setup where the load balancer terminates and re-establishes both sides of the connection](/images/content/f5-bigip-next-and-distributed-cloud/full_proxy.png)
...
![The internal architecture of a BIG-IP system](/images/content/f5-bigip-next-and-distributed-cloud/bigIparchi.png)

## BigIP components

![The BIG-IP components and how they relate](/images/content/f5-bigip-next-and-distributed-cloud/bigIpcomponent.png)

**Process:**

![The BIG-IP processing steps](/images/content/f5-bigip-next-and-distributed-cloud/bigIpsteps.png)
...
![The move from a monolithic application to microservices](/images/content/f5-bigip-next-and-distributed-cloud/monolithic_microservices.png)

Multicloud: use multiple cloud providers as well as on-prem for sensitive stuff.

![The infrastructure of a microservices application](/images/content/f5-bigip-next-and-distributed-cloud/microservices_infra.png)
...
![The problems F5 Distributed Cloud is solving](/images/content/f5-bigip-next-and-distributed-cloud/what_f5_XC_is_solving.png)
...
![Bot defense machine learning in F5 Distributed Cloud](/images/content/f5-bigip-next-and-distributed-cloud/Bot_defence_ML_BigIPXC.png)
