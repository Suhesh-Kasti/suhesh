...
- [ ] Step 2:
![The /backup directory listing that exposes the application's backup files](/images/content/lab--portswigger-source-code-disclosure-via-backup-files/backup_folder_found.png)
