...
![The data, control and management planes that split up the work inside a network device](/images/content/networking/notThumb/Data_Control_Management_Planes.png)
...
![A distributed control plane, where every router and switch makes its own forwarding decisions](/images/content/networking/notThumb/Distributed_Control_Plane.png)
...
![Controller-based networking, where the devices give up their own control planes and follow one central SDN controller](/images/content/networking/notThumb/Controller_Based_Networking_Zombie.png)
...
![Spine-leaf data center topology, with leaf switches connecting the servers up to spine switches](/images/content/networking/notThumb/Spine_Leaf_in_data_center.png)
