...
| SSL Offloading | ![Traffic decrypted at the load balancer and passed to the server in plaintext](/images/content/ssl-offloading-on-big-ip/ssl_offloading.png) |
| --- | --- |
| **SSL Bridging** | ![Traffic decrypted at the load balancer, inspected, then re-encrypted to the server](/images/content/ssl-offloading-on-big-ip/ssl_bridging.png) |
