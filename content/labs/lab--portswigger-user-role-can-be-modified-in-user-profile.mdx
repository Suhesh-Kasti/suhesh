...
![The email-change response showing the roleid value modified to 2 for admin access](/images/content/lab--portswigger-user-role-can-be-modified-in-user-profile/role_id_changed_access_control.png)
