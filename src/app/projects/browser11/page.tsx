...
export const metadata: Metadata = {
  alternates: { canonical: "https://suhesh.com.np/projects/browser11" },
...
export default function Browser11Page() {
  return (
    <ProjectLayout title="Browser 11" category="Web Experiment" color={COLORS.blue}>
      ...
      <h2 className="font-display text-lg font-extrabold uppercase mt-8 mb-4">What I Built</h2>
      ...
      <h2 className="font-display text-lg font-extrabold uppercase mt-8 mb-4">Key Features</h2>
      ...
      <h2 className="font-display text-lg font-extrabold uppercase mt-8 mb-4">What I Learned</h2>
