...
![JWT request with the signature removed and the alg header set to none](/images/content/lab--portswigger-jwt-authentication-bypass-via-flawed-signature-verification/jwt_sent_with_none_algo.png)
