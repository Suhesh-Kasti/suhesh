...
tags:
  ...
  - walkthrough
excerpt: >-
  PortSwigger Web Security Academy lab — SQL injection attack, querying the
  database type and version on Oracle. Walkthrough with solution, key takeaways,
  and blind replay exercise.
type: lab
