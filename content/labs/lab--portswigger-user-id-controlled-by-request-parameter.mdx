...
![The account page for carlos after changing the id parameter from my own user](/images/content/lab--portswigger-user-id-controlled-by-request-parameter/horizontal_account_takeover_by_req_parameter_change.png)
