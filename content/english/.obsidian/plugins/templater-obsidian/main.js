...
var kn = (r) => ir(r, "__esModule", { value: !0 });
var Wi = (r, e) => {
    kn(r);
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let n of Hi(e))
        !Vi.call(r, n) &&
          ...
          ir(r, n, {
            get: () => e[n],
            enumerable: !(t = Li(e, n)) || t.enumerable,
          });
    return r;
  },
  G = (r) =>
...
Wi(exports, { default: () => dn });
var _r = G(require("obsidian"));
var I = G(require("obsidian"));
var Fn = G(require("obsidian"));
function K(r) {
  let e = new Fn.Notice("", 8e3);
...
var Qn = G(require("obsidian"));
var Jn = G(require("obsidian"));
var W = "top",
  Z = "bottom",
  Q = "right",
  U = "left",
...
function xe(r) {
  for (var e = Y(r), t = qn(r); t && kr(t) && Ae(t).position === "static"; )
    t = qn(t);
  return t &&
...
function Cn(r) {
  ...
  if (g) {
    ...
    if (o === U || ((o === W || o === Z) && s === at)) {
      N = Q;
      var V = b && q === S && S.visualViewport ? S.visualViewport.width : q[z];
      (x -= V - n.width), (x *= A ? 1 : -1);
    }
  }
  var m = Object.assign({ position: p }, g && co),
    h = f === !0 ? Ao({ x, y: M }, Y(t)) : { x, y: M };
  if (((x = h.x), (M = h.y), A)) {
    var c;
...
function Nn(r, e, t) {
  return e === sr ? Et(Tr(r, t)) : he(e) ? go(e, t) : Et(Fr(ne(r)));
}
function ho(r) {
  var e = et(Ue(r)),
...
function Mr(r, e, t, n) {
  var o = e === "clippingParents" ? ho(r) : [].concat(e),
    s = [].concat(o, [t]),
    l = s[0],
    p = s.reduce(
      function (A, g) {
...
function Ee(r, e) {
  ...
  var t = e,
    ...
    N = r.rects.popper,
    T = r.elements[O ? L : k],
    S = Mr(he(T) ? T : T.contextElement || ne(r.elements.popper), A, f, l),
  ...
  if (!!q) {
    if (s) {
      var c,
        ...
        H = _[ue],
        Re = pt(0, R[oe], y[oe]),
        C = N ? R[oe] / 2 - gt - Re - F - V.mainAxis : Me - Re - F - V.mainAxis,
        le = N
          ? -R[oe] / 2 + gt + Re + H + V.mainAxis
          : Ne + Re + H + V.mainAxis,
    ...
    if (p) {
      var Ut,
        ...
        Zt = Mt ? Xt : He - R[ht] - z[ht] - ot + V.altAxis,
        Pe = Mt ? He + R[ht] + z[ht] - ot - V.altAxis : Qt,
        X = x && Mt ? In(Zt, He, Pe) : pt(x ? Zt : Xt, He, x ? Pe : Qt);
      (q[S] = X), (h[S] = X - He);
    }
    e.modifiersData[n] = h;
  }
    ...
    var f = {
      ...
      x = {
        ...
        setOptions: function (P) {
          ...
          var N = Sr(Dr([].concat(n, f.options.modifiers)));
          return (
        ...
        forceUpdate: function () {
          if (!k) {
            ...
            if (!!Un(L, N)) {
              (f.rects = {
                reference: Ir(L, xe(N), f.options.strategy === "fixed"),
                popper: ct(N),
              }),
                (f.reset = !1),
...
var To = [$n, Vn, Dn, On, Gn, Rn, Wn, Sn, Hn],
  $r = zn({ defaultModifiers: To });
var Fo = (r, e) => ((r % e) + e) % e,
  Xn = class {
    constructor(e, t, n) {
      (this.owner = e),
    ...
    setSelectedItem(e, t) {
      let n = Fo(e, this.suggestions.length),
  ...
  Nt = class {
    constructor(e) {
      (this.inputEl = e),
        (this.scope = new Jn.Scope()),
        (this.suggestEl = createDiv("suggestion-container"));
      let t = this.suggestEl.createDiv("suggestion");
      (this.suggest = new Xn(this, t, this.scope)),
    ...
    open(e, t) {
      app.keymap.pushScope(this.scope),
        ...
        (this.popper = $r(t, this.suggestEl, {
...
var ri = G(require("obsidian"));
var qe = G(require("obsidian"));
function pr(r) {
...
var ni = {
  ...
  Nr = class extends I.PluginSettingTab {
    constructor(e) {
      super(app, e);
      this.plugin = e;
    }
  ...
  getItemText(e) {
    ...
    return (
      e.path.startsWith(this.plugin.settings.templates_folder) &&
        (0, ur.normalizePath)(this.plugin.settings.templates_folder) != "/" &&
...
var Hr = class extends pe {
  ...
  generate_daily_quote() {
    return async () => {
      try {
        let t = (await this.getRequest("https://api.quotable.io/random")).json,
          n = t.author;
...
var Ce = G(require("obsidian"));
var Wr = class extends Ce.Modal {
  constructor(e, t, n) {
    super(app);
    this.prompt_text = e;
...
var li = G(require("obsidian")),
  Kr = class extends li.FuzzySuggestModal {
    constructor(e, t, n, o) {
      super(app);
      this.text_items = e;
      this.items = t;
...
var Jr = class {
  constructor(e) {
    ...
    this.modules_array.push(new Yr(this.plugin)),
      ...
      this.modules_array.push(new zr(this.plugin));
  }
  async init() {
...
var ci = G(require("child_process")),
  Ai = G(require("util")),
  Gt = G(require("obsidian"));
var Xr = class {
  constructor(e) {
    this.plugin = e;
    ...
    !(app.vault.adapter instanceof Gt.FileSystemAdapter)
      ...
      : ((this.cwd = app.vault.adapter.getBasePath()),
        (this.exec_promise = (0, Ai.promisify)(ci.exec)));
  }
...
var Zr = class {
  constructor(e) {
    this.plugin = e;
    (this.user_system_functions = new Xr(e)),
      (this.user_script_functions = new Qr(e));
  }
  async generate_object(e) {
    let t = {},
      n = {};
...
var en = class {
  constructor(e) {
    this.plugin = e;
    (this.internal_functions = new Jr(this.plugin)),
      (this.user_functions = new Zr(this.plugin));
  }
  async init() {
...
var pi = new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 });
pi.decode();
var mr = new Uint8Array();
function fr() {
  return mr.byteLength === 0 && (mr = new Uint8Array(v.memory.buffer)), mr;
}
function tt(r, e) {
  return pi.decode(fr().subarray(r, r + e));
}
function rt(r) {
...
var Te = 0,
  dr = new TextEncoder("utf-8"),
  Oo =
    typeof dr.encodeInto == "function"
      ? function (r, e) {
          return dr.encodeInto(r, e);
        }
      : function (r, e) {
          let t = dr.encode(r);
...
var gr = new Int32Array();
function ge() {
  return gr.byteLength === 0 && (gr = new Int32Array(v.memory.buffer)), gr;
}
function rn(r) {
  let e = typeof r;
...
var hr = 32;
function So(r) {
  if (hr == 1) throw new Error("out of js stack");
  return (ke[--hr] = r), hr;
}
function nn(r, e) {
  try {
    ...
    render_content(e, t) {
      try {
        let l = v.__wbindgen_add_to_stack_pointer(-16),
          ...
          A = Te;
        v.renderer_render_content(l, this.ptr, p, A, So(t));
        var n = ge()[l / 4 + 0],
          o = ge()[l / 4 + 1],
          s = ge()[l / 4 + 2];
        if (s) throw tn(o);
        ...
        v.__wbindgen_add_to_stack_pointer(16), (ke[hr++] = void 0);
      }
    }
  };
...
function Do() {
  ...
  return (
    ...
    (r.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var s = qo(o) ? 0 : ze(o, v.__wbindgen_malloc, v.__wbindgen_realloc),
        l = Te;
...
async function ui(r) {
  typeof r == "undefined" && (r = new URL("rusty_engine_bg.wasm", Ro.url));
  let e = Do();
  (typeof r == "string" ||
    ...
    (r = fetch(r)),
    $o(e);
  let { instance: t, module: n } = await Co(await r, e);
  return No(t, n);
}
var mi = ui;
var fi = Tn(
...
var Wt = class {
  constructor(e) {
    this.plugin = e;
    (this.functions_generator = new en(this.plugin)), (this.parser = new on());
  }
  async setup() {
...
var ln = class {
  ...
  async jump_to_next_cursor_location() {
    ...
    if (o) {
      let s = e instanceof an.MarkdownView ? e.currentMode.getFoldInfo() : null;
      e.editor.setValue(n),
        s &&
          ...
          e instanceof an.MarkdownView && e.currentMode.applyFoldInfo(s)),
...
var Ho = [
  ...
  Go = new Set(Ho);
function ji(r) {
  return typeof r == "string" && Go.has(r);
}
function _i(r) {
  return !!r.definition;
}
...
var An = class extends vi.EditorSuggest {
  constructor(e) {
    super(app);
    this.tp_keyword_regex =
      /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-z_]*)?)?$/;
    this.documentation = new cn(e);
  }
  onTrigger(e, t, n) {
...
(function (r) {
  ...
  r.defineMode("javascript", function (e, t) {
      ...
      if (!(u < 0)) {
        ...
        for (var E = 0, B = !1, $ = u - 1; $ >= 0; --$) {
          ...
          if (Be >= 0 && Be < 3) {
            ...
            for (; ; --$) {
              if ($ == 0) return;
              var Ri = i.string.charAt($ - 1);
              if (Ri == ce && i.string.charAt($ - 2) != "\\") {
                $--;
                break;
              }
            }
                  ...
                  : i == ";"
                    ...
                    : i == "if"
                      ...
                      : i == "function"
                        ? c(Qe)
                        : i == "for"
                          ? c(y("form"), Ne, _n, H, ae, _)
                          : i == "class" || (A && a == "interface")
                            ? ((m.marked = "keyword"),
                              c(y("form", i == "class" ? i : a), wn, _))
                            : i == "variable"
                              ? A && a == "declare"
    ...
    function Kt(i, a, u) {
      ...
      return R.hasOwnProperty(i)
        ...
        : i == "function"
          ? c(Qe, E)
          : i == "class" || (A && a == "interface")
            ? ((m.marked = "keyword"), c(y("form"), qi, _))
            : i == "keyword c" || i == "async"
              ? c(u ? le : C)
              : i == "("
                ? c(y(")"), Ye, F(")"), _, E)
    ...
    function gn(i) {
      if (A && i == ":")
        return m.stream.match(/^\s*\w+\s+is\b/, !1) ? c(C, Ei, D) : c(D);
    }
    function Ei(i, a) {
    ...
    function D(i, a) {
      ...
      if (i == "{") return c(y("}"), vr, _, Ge);
      if (i == "(") return c(X(br, ")"), ki, Ge);
      if (i == "<") return c(X(D, ">"), D);
      if (i == "quasi") return h(wr, Ge);
    }
    function ki(i) {
      if (i == "=>") return c(D);
    }
    ...
    function Bt(i, a) {
      ...
      if (i == ":") return c(D);
      if (i == "[") return c(F("variable"), xi, F("]"), Bt);
      if (i == "(") return h(vt, Bt);
      if (!i.match(/[;\}\)\],]/)) return c();
    }
    function wr(i, a) {
    ...
    function Ti(i) {
      if (i == "}")
        return (m.marked = "string-2"), (m.state.tokenize = T), c(wr);
    }
    function br(i, a) {
    ...
    function yr(i, a) {
      return a == "enum" ? ((m.marked = "keyword"), c(xn)) : h(be, jt, Xe, Bi);
    }
    function be(i, a) {
    ...
    function _n(i, a) {
      if (a == "await") return c(_n);
      if (i == "(") return c(y(")"), Oi, _);
    }
    function Oi(i) {
      return i == "var" ? c(yr, _t) : i == "variable" ? c(_t) : h(_t);
    }
    function _t(i, a) {
      return i == ")"
        ? c()
    ...
    function qi(i, a) {
      return i == "variable" ? wn(i, a) : rr(i, a);
    }
    function wn(i, a) {
    ...
    function nr(i, a) {
      return i == "{"
        ? Pt(nr, "}")
        : (i == "variable" && ue(a), a == "*" && (m.marked = "keyword"), c(Ci));
    }
    function yn(i) {
      if (i == ",") return c(nr, yn);
    }
    ...
    function xn() {
      return h(y("form"), be, F("{"), y("}"), X($i, "}"), _, _);
    }
    function $i() {
      return h(be, Xe);
    }
    ...
    return {
      ...
      jsonldMode: s,
      jsonMode: l,
      expressionAllowed: En,
      skipExpression: function (i) {
        V(i, "atom", "atom", "true", new r.StringStream("", 2, null));
      },
    };
  }),
...
var wi = G(require("@codemirror/language")),
  bi = G(require("@codemirror/state")),
  yi = "templater",
  un = "templater-command",
  mn = "templater-inline",
  Vo = "templater-opening-tag",
  Wo = "templater-closing-tag",
  Ko = "templater-interpolation-tag",
  Uo = "templater-execution-tag",
  fn = class {
    constructor(e) {
      this.plugin = e;
      (this.cursor_jumper = new ln()), (this.activeEditorExtensions = []);
    }
    desktopShouldHighlight() {
      return (
        pn.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting
      );
    }
    mobileShouldHighlight() {
      return (
        pn.Platform.isMobileApp &&
        this.plugin.settings.syntax_highlighting_mobile
      );
    }
    async setup() {
      this.plugin.registerEditorSuggest(new An(this.plugin.settings)),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = bi.Prec.high(
          wi.StreamLanguage.define(window.CodeMirror.getMode({}, yi)),
        )),
    ...
    async registerCodeMirrorMode() {
      ...
      window.CodeMirror.defineMode(yi, function (n) {
        let o = {
          startState: function () {
            return {
          ...
          token: function (s, l) {
            if ((s.sol() && l.inCommand && (l.freeLine = !0), l.inCommand)) {
              ...
              if (s.match(/[-_]{0,1}%>/, !0)) {
                ...
                let f = l.tag_class;
                return (l.tag_class = ""), `line-${mn} ${un} ${Wo} ${f}`;
              }
            ...
            if (p != null) {
              ...
              return (
                (l.inCommand = !0), `line-${mn} ${un} ${Vo} ${l.tag_class}`
              );
            }
...
var dn = class extends _r.Plugin {
  async onload() {
    await this.load_settings(),
      (this.templater = new Wt(this)),
      await this.templater.setup(),
      (this.editor_handler = new fn(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new Rr(this)),
      (this.event_handler = new jr(this, this.templater, this.settings)),
      this.event_handler.setup(),
      (this.command_handler = new sn(this)),
      this.command_handler.setup(),
      (0, _r.addIcon)("templater-icon", oi),
      this.addRibbonIcon("templater-icon", "Templater", async () => {
        this.fuzzy_suggester.insert_template();
      }).setAttribute("id", "rb-templater-icon"),
      this.addSettingTab(new Nr(this)),
  ...
  async load_settings() {
    this.settings = Object.assign({}, ni, await this.loadData());
  }
};
