...
- [ ] Step 2:
- [ ] Step 3:
![Request to the root path carrying an X-Original-URL header that points at /admin](/images/content/lab--portswigger-url-based-access-control-can-be-circumvented/req_with_x-original-url.png)
- [ ] Final payload / exploit:
![The delete-user request succeeding through the X-Original-URL header bypass](/images/content/lab--portswigger-url-based-access-control-can-be-circumvented/username_deleted_with_x-original-url.png)
