...
![The body of the 302 redirect response leaking carlos's API key before the redirect is followed](/images/content/lab--portswigger-user-id-controlled-by-request-parameter-with-data-leakage-in-redirect/information_exposed_in_302_redirection_found.webp)
