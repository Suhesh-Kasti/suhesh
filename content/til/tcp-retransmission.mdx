...
![A Wireshark capture showing the client's initial hello and the retransmission that follows when no reply arrives](/images/content/tcp-retransmission/tcp_retransmission_initial_hello.png)
