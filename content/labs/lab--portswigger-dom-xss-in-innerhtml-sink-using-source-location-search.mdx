...
![Browser devtools showing the search term written into the span through innerHTML](/images/content/lab--portswigger-dom-xss-in-innerhtml-sink-using-source-location-search/DOM_XSS_innerHTML.webp)
