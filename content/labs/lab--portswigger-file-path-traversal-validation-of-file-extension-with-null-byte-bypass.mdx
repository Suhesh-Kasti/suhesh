...
tags:
  ...
  - walkthrough
excerpt: >-
  PortSwigger Web Security Academy lab — File path traversal, validation of file
  extension with null byte bypass. Walkthrough with solution, key takeaways, and
  blind replay exercise.
type: lab
