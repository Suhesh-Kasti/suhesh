document.addEventListener("DOMContentLoaded", async function () {
  ...
  // Dynamic fetch logic replaced questionSets
  let fetchedQuestions = [];
  try {
    const response = await fetch(`/questions/wordfill/${wordCode}.json`);
    ...
    if (document.getElementById("question-word")) {
      document.getElementById("question-word").innerText = "Check back soon for the questions!";
    }
    return;
  }

  var questionSets = {};
  questionSets[wordCode] = fetchedQuestions;
