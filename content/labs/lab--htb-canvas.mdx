...
title: "HTB — Canvas"
date: '2026-06-30'
tags: ["lab/htb", "walkthrough", "Programming", "Enumeration"]
excerpt: "An HTB misc challenge: a login script is obfuscated with hex strings, and deobfuscating it exposes a String.fromCharCode blob hiding the flag."
type: lab
...
<Cloze title="Canvas recall" color="#8800ff" text="The obfuscated login compares both the username and the password to {{admin}}. The flag hides in a {{String.fromCharCode}} blob, which you read by converting the decimal codes back to {{ASCII}}." />
