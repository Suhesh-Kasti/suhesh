...
![The /api documentation showing the checkout endpoint and its GET and POST methods](/images/content/lab--portswigger-api--mass-assignment-vuln/api-mass-assign-api-doc.png)
- **Where I got stuck:**
...
- [ ] Step 3:  Made this post request according to the documentation![POST request to /api/checkout carrying the chosen_discount field the UI never sends](/images/content/lab--portswigger-api--mass-assignment-vuln/api-mass-assignment-assigned-discount.png)
