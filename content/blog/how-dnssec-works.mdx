...
![DNS records of the same type and label being grouped into a single resource record set](/images/content/how-dnssec-works/rrset_Allocation.png)
...
![The RRSET being signed with the private zone-signing key and the resulting RRSIG stored alongside it](/images/content/how-dnssec-works/howDNSSECworks.png)
